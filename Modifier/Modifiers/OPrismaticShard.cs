...
public class OPrismaticShardModifier : RogueModifier {
	...
	public override string Description => "Tower and Hero Choices are replaced by Prismatic Choices, which include Monkeys and Heros"; //"Gain one less Monkey from Tower and Paragon Choices"
